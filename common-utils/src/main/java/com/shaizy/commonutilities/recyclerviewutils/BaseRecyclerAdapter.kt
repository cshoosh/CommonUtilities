package com.shaizy.commonutilities.recyclerviewutils
...
import com.shaizy.commonutilities.R

/**
 * Created by syed.shahnawaz on 7/11/2017.
 * Helper class for Recycler View Adapter
 */
...
abstract class BaseRecyclerAdapter<T, K : RecyclerView.ViewHolder>() :
    ...
    inner class EmptyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val image : ImageView= itemView.findViewById(android.R.id.icon)
        val button : Button= itemView.findViewById(android.R.id.button1)
