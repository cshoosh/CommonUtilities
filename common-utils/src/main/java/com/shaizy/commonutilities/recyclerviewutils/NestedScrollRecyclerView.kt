...
/**
 * Created by syedshahnawazali on 20/03/2018.
 * Allows Scrolling for child in recycler view
 */
open class NestedScrollRecyclerView : RecyclerView, NestedScrollingParent {
